    ...
    <nav className="bg-gradient-to-r from-purple-900 via-blue-300 to-green-300 text-white" style={{ background: 'blue', backgroundImage: 'linear-gradient(-180deg, rgba(255,255,255,0.50) 0%, rgba(0,0,0,0.50) 100%)', backgroundBlendMode: 'lighten' }}>
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex justify-center flex-grow md:flex-grow-0">
            <div className="hidden md:flex space-x-4">
             ...
             <NavLink to="/" className="text-black-900 hover:bg-black-700 hover:text-gray-500 hover:text-white hover:underline px-3 py-2 rounded-md text-sm font-bold">Home</NavLink>
      ...
      <div className={`${isOpen ? 'block' : 'hidden'} md:hidden`}>
        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
         <NavLink to="#" className="text-black-900 hover:bg-black-700 hover:text-white block px-3 py-2 rounded-md text-base font-bold">Home</NavLink>
         <NavLink to="#" className="text-black-900 hover:bg-black-700 hover:text-white block px-3 py-2 rounded-md text-base font-bold">About</NavLink>
         <NavLink to="#" className="text-black-900 hover:bg-black-700 hover:text-white block px-3 py-2 rounded-md text-base font-bold">Services</NavLink>
         <NavLink to="#" className="text-black-900 hover:bg-black-700 hover:text-white block px-3 py-2 rounded-md text-base font-bold">Contact</NavLink>
        </div>
      </div>
    </nav>
  );
