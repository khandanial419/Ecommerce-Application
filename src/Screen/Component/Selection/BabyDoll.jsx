  ...
  React.useEffect(() => {
    const fetBabyDollData = async () => {
      try {
        ...
        setBabyDoll(data.data); // Assuming data.data contains the array of products
      } catch (error) {
    ...
    fetBabyDollData(); // Call the fetchDataMen function when the component mounts
